...
public class CapNhatChuHo extends javax.swing.JDialog {
    ...
    public CapNhatChuHo(MainNhanVienView Frame, DSChuHoView FrameChuHoView, boolean modal) {
        initComponents();
        ...
        HoTenTF.setText(dSChuHoView.getHoTen());
        DobDC.setDate(dSChuHoView.getNgaySinh());
        DiaChiTF.setText(dSChuHoView.getDiaChi());
        SdtTF.setText(dSChuHoView.getSdt());
        
        CccdTF.setEnabled(false);
        cccdNVTF.setEnabled(false);
    }
    ...
    private void initComponents() {
        ...
        okBT2.setText("OK");
        okBT2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                okBT2ActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addComponent(okBT2, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(42, 42, 42)
    ...
    private void okBT2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okBT2ActionPerformed
        ...
        if(CccdTF.getText().equals("") || SdtTF.getText().equals("") || HoTenTF.getText().equals("")
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                JOptionPane.showMessageDialog(this, "Đã cập nhật tài khoản của chủ hộ có CCCD: " + CccdTF.getText());
    ...
    }//GEN-LAST:event_okBT2ActionPerformed
    ...
    private javax.swing.JButton okBT2;
